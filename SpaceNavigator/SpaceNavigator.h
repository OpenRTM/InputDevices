...
{
public:
	SpaceNavigator(RTC::Manager* manager);
	~SpaceNavigator();
	...
	void defaultMapping(std::vector<double>& pos);
	void screenMapping(std::vector<double>& pos);
...
protected:
	...
	TimedShortSeq m_button;
	OutPort<TimedShortSeq> m_buttonOut;
...
private:
	InputDevice::SpaceNavigator m_sn;
	int dummy;
};
